@echo off
REM ChillPatcher Audio Decoder - Build Script for Windows
...
echo ========================================
echo ChillPatcher Audio Decoder Build Script
echo ========================================
...
copy /Y "%BUILD_X64%\bin\Release\ChillAudioDecoder.dll" "%OUTPUT_DIR%\x64\" >nul
copy /Y "%BUILD_X86%\bin\Release\ChillAudioDecoder.dll" "%OUTPUT_DIR%\x86\" >nul

echo.
echo ========================================
echo Build Complete!
echo ========================================
echo x64 DLL: %OUTPUT_DIR%\x64\ChillAudioDecoder.dll
echo x86 DLL: %OUTPUT_DIR%\x86\ChillAudioDecoder.dll
echo ========================================
